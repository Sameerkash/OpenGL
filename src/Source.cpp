...
#define SPEED 650	// Speed of sorting, must be greater than MAX always
int a[MAX];			// Array
...
void front()
{
	...
	bitmap_output(150, 500, "SANJANA PL (1KG17CS071)", GLUT_BITMAP_TIMES_ROMAN_24);
	//glBegin(GL_LINE_LOOP);
	//glVertex2f(325, 521);
	//glVertex2f(360, 521);
	//glEnd();

	bitmap_output(150, 400, "DYNAMIC SORTING ALGORITHM VISUALIZER", GLUT_BITMAP_TIMES_ROMAN_24);
	glBegin(GL_LINE_LOOP);
	glVertex2f(145, 470);
	glVertex2f(520, 470);
	glEnd();
